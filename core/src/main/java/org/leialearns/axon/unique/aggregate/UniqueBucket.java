package org.leialearns.axon.unique.aggregate;
...
import org.leialearns.axon.unique.event.*;
...
public class UniqueBucket {
    ...
    @CommandHandler
    public String handle(AddUniqueKeyCommand command, StackCommandGateway commandGateway) {
    ...
    private String getChildId(String childKey, StackCommandGateway commandGateway) {
    ...
    @CommandHandler
    public void handle(CleanExistingKeysCommand command, StackCommandGateway commandGateway) {
