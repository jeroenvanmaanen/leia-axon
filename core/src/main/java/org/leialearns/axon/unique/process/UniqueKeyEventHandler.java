...
import org.leialearns.axon.unique.event.FullPrefixAddedEvent;
import org.leialearns.axon.unique.event.UniqueBucketChildAddedEvent;
import org.leialearns.axon.unique.persistence.UniqueBucketDocument;
...
public class UniqueKeyEventHandler {
    ...
    public UniqueKeyEventHandler(MongoTemplate mongoTemplate) {
